...
async def pyro_str():
    ...
    async with Client(":memory:", api_id, api_hash) as NEXAUB:
        ...
        await session_msg.reply_text("Successfully Generated String Session! Thanks for trying [Nexa Userbot](https://t.me/Nexa_Userbot) \n\n**Join @Nexa_userbot_chat**", disable_web_page_preview=True)
